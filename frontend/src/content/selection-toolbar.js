// Shows a small floating toolbar near any text the user selects on a page,
// with quick actions (Explain / Summarize). Runs alongside content.js as a
// separate content script - talks to it via a custom DOM event instead of
// calling its functions directly, so the two files stay independent.
...
// Hide the toolbar if the user clicks elsewhere or scrolls the page.
